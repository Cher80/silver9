...
public class AlbumThumb extends Composite  {
	...
	//private FocusPanel albumImageHoverFix = new FocusPanel();
	...
	public AlbumThumb(AlbumObj albumObjj) {
		...
		//albumImage.getElement().setAttribute("onclick", "void(0)");
		//albumImage.getElement().getStyle().setProperty("onclick", "void(0)");
		...
		//layerHover.getElement().setAttribute("onclick", "void(0)");
		...
		/*
		albumImageHoverFix.addStyleName("albumImageHoverFix");
		//albumImageHoverFix.getElement().setAttribute("onclick", "void(0)");
		//albumImageHoverFix.getElement().getStyle().setProperty("onclick", "void(0)");
		albumImageHoverFix.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				gotoAlbPage();
			}
		}); 
		panel.add(albumImageHoverFix);
		*/
		...
		statusAdmin.setText(statusDigit);
